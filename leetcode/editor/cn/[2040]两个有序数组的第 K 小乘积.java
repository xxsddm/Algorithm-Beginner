...
class Solution {
    ...
    public long kthSmallestProduct(int[] nums1, int[] nums2, long k) {  // 二分
        this.k = k;
        ...
        len1 = arr1.length;
        len2 = arr2.length;
        long left = Math.min((long) arr1[0] * arr2[0],
                Math.min((long) arr1[0] * arr2[len2 - 1],
                        (long) arr1[len1 - 1] * arr2[0]));
        long right = Math.max((long) arr1[0] * arr2[0],
                Math.max((long) arr1[len1 - 1] * arr2[len2 - 1],
                        Math.max((long) arr1[0] * arr2[len2 - 1],
                                (long) arr1[len1 - 1] * arr2[0])));
        while (left <= right) {
    ...
    int bisect(long target, boolean equal) {
